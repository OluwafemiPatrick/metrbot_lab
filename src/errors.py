...
class ErrorCode(StrEnum):
    ...
    INVALID_CONFIGURATION_SECTION = "INVALID_CONFIGURATION_SECTION"
    INVALID_CONFIGURATION_OVERRIDE = "INVALID_CONFIGURATION_OVERRIDE"
    CONFIGURATION_FILE_ERROR = "CONFIGURATION_FILE_ERROR"
    ...
    INVALID_STRATEGY_REGISTRY = "INVALID_STRATEGY_REGISTRY"
    STRATEGY_ALREADY_EXISTS = "STRATEGY_ALREADY_EXISTS"
    STRATEGY_SCAFFOLD_ERROR = "STRATEGY_SCAFFOLD_ERROR"
    STRATEGY_REMOVAL_ERROR = "STRATEGY_REMOVAL_ERROR"
    PROTECTED_STRATEGY = "PROTECTED_STRATEGY"
    UNSAFE_STRATEGY_PATH = "UNSAFE_STRATEGY_PATH"
